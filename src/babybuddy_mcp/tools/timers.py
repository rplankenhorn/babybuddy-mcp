...
from ..client import api_delete, api_get, api_list, api_patch, api_post
...
async def create_timer(
    ...
    """Start a new timer. The timer begins at the current time. Use the returned ID when finishing a feeding, sleep, pumping, or tummy time session."""
...
async def delete_timer(
    ...
    """Stop and delete a timer. This does not create any records — use create_feeding, create_sleep, etc. with a timer_id first to log the session."""
